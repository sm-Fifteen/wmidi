...
impl U7 {
    ...
    ///
    /// # Safety
    /// data must be between `U7::MIN` and `U7::MAX` inclusively.
    #[inline(always)]
    ...
    ///
    /// # Safety
    /// All elements in `bytes` must be between `U7::MIN` and `U7::MAX` inclusively.
    #[inline(always)]
...
impl U14 {
    ...
    ///
    /// # Safety
    /// data must be between `U14::MIN` and `U14::MAX` inclusively.
    #[inline(always)]
    ...
    ///
    /// # Safety
    /// All elements in `bytes` must be between `U14::MIN` and `U14::MAX` inclusively.
    #[inline(always)]
